...
const Header: React.FC = () => {
  ...
  const navLinks = isAuthenticated
    ? [
        { to: ROUTES.CHOOSE_CHARACTER, label: "Character" },
      ...
      >
        ...
        >
          ...
          {isAuthenticated && user ? (
            <>
              <Link to={ROUTES.SETTINGS} aria-label="Settings" className="header-settings-link" data-active={isActive(ROUTES.SETTINGS)}>
                <button
                  type="button"
              ...
              <Link to={ROUTES.MOCK_TEST}>
                <button type="button" className="header-start-test-btn" style={startTestBtnStyle}>Start a Test</button>
              </Link>
            </>
          ) : (
            <>
        ...
        >
          {isAuthenticated && user ? (
            <Link to={ROUTES.SETTINGS} aria-label="Settings" className="header-settings-link header-mobile-settings" data-active={isActive(ROUTES.SETTINGS)}>
              <button
                type="button"
                className="header-settings-btn"
                style={{
